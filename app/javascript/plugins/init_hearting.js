const initHearting = () => {
  ...
  // 2 - contrôleur likes : méthode show
  //  -> paramètre exhibition_id + current_user
  //  -> définit la variable @like_exists (true ou false)
  // 3 - show.html.erb
  //   -> injecte la variable @likes dans un JSON {"like_exists":false/true} (vérifier dans l'onglet network la réponse obtenue)
